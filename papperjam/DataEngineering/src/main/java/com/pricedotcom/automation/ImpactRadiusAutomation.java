...
public class ImpactRadiusAutomation {
	...
	// Add logger instance
	Logger logger = Logger.getLogger(ImpactRadiusAutomation.class);
	...
	public void automate(String hostName, String userName, String password, int port, String sourceFolderName,
		...
		try {
			...
			if (s3flag == 1) {
				...
				if (affiliator.equalsIgnoreCase("impactradius")
	...
	public static void main(String args[]) throws IOException {
		ImpactRadiusAutomation auto = new ImpactRadiusAutomation();
