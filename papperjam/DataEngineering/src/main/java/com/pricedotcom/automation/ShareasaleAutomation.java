...
public class ShareasaleAutomation {
	...
	// Add logger instance
	Logger logger = Logger.getLogger(ShareasaleAutomation.class);
	...
	public void automate(String hostName, String userName, String password, int port, String sourceFolderName,
		...
		try {
			...
			if (s3flag == 1) {
				...
				if (affiliator.equalsIgnoreCase("shareasale")
	...
	public static void main(String args[]) throws IOException {
		ShareasaleAutomation auto = new ShareasaleAutomation();
		...
		int port = 21;
		String sourceFolderName = "/11035";
		String sourceFile = "11035-422.txt.gz";
		String retailer = "Wayfair";
		String affiliator = "Shareasale";
		String delimiter = "|";
		String retailerno = "34";
