...
import com.pricedotcom.automation.ImpactRadiusAutomation;
import com.pricedotcom.automation.PapperjamAutomation;
import com.pricedotcom.automation.ShareasaleAutomation;
import com.pricedotcom.elasticsearch.AmazonESOperations;
...
import com.pricedotcom.test.AmazonESPush;
...
public class TransferFiles {
	...
	final static AmazonESOperations amazones = new AmazonESOperations();
	final static ShareasaleAutomation ssauto = new ShareasaleAutomation();
	final static PapperjamAutomation pjauto = new PapperjamAutomation();
	final static ImpactRadiusAutomation irauto = new ImpactRadiusAutomation();
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException, InterruptedException {
		...
		try {
			...
			if (classtype.equals("producer")) {
				...
				amazones.getRows(targetTable, "amazon");
			}
			...
			}else if(classtype.equals("pjauto")){
				...
				pjauto.automate(hostName, userName, password, port, sourceFolderName, sourceFile, retailer, affiliator, delimiter, retailerno,loadType,s3flag,mysqlflag,esflag);
				
			}else if(classtype.equals("ssauto")){
				...
				ssauto.automate(hostName, userName, password, port, sourceFolderName, sourceFile, retailer, affiliator, delimiter, retailerno,loadType,s3flag,mysqlflag,esflag);
				
			}else if(classtype.equals("irauto")){
				...
				irauto.automate(hostName, userName, password, port, sourceFolderName, sourceFile, retailer, affiliator, delimiter, retailerno,loadType,s3flag,mysqlflag,esflag);
