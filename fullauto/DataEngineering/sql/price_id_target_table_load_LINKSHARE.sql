...
\
use production;\
load data local infile \cf2 '~/s3upload/DataEngineering/data/Johnston&Murphy/42258_3310515_107901534_cmp.txt'\cf0  \cf3 into\cf0  \cf3 table\cf0  STG_JOHNSONMURPHY_LINKSHARE_W fields terminated \cf3 by\cf0  \cf2 '|'\cf0  ;\
\
\cf4 ---when matches\cf0 \
\
...
\cf4 -- change the staging table name and the retailer_code\cf0 \
...
(\cf5 SELECT\cf0 \
    FIELD_24 \cf3 AS\cf0  UPC,\
    $\cf2 13\cf0  \cf3 AS\cf0  RETAILER_CODE,\
    FIELD_1 \cf3 AS\cf0  ITEM_ID\
...
\cf4 -- LINKSHARE INSERTS\cf0 \
\
\cf4 -- create table PRICE_DOT_COM_TRGT.TRGT_FINISH_LINE_LINKSHARE_DATE \cf0 \
\cf4 -- as \cf0 \
\cf4 -- select * from PRICE_DOT_COM_TRGT.TRGT_FINISH_LINE_LINKSHARE;\cf0 \
\
...
\cf5 select\cf0 \
  a.FIELD_1 \cf3 as\cf0  ITEM_ID,\
  a.FIELD_2 \cf3 as\cf0  TITLE,\
  a.FIELD_24 \cf3 as\cf0  UPC,\
  SUBSTRING_INDEX(a.FIELD_6, \cf2 'murl='\cf0 , \cf2 -1\cf0 ) \cf3 as\cf0  PRODUCT_URL,\
  a.FIELD_7 \cf3 as\cf0  IMAGE_URL,\
  b.common_id \cf3 as\cf0  PRICE_ID,\
  a.FIELD_13 + \cf2 ' '\cf0  \cf3 AS\cf0  PRICE1,\
  a.FIELD_14 + \cf2 ' '\cf0  \cf3 AS\cf0  PRICE2\
\cf3 from\cf0  $STG_FINISHLINE_LINKSHARE_W_VIKASH a, UPC_COMMON_ID_MAP2 b\
\cf3 where\cf0  a.FIELD_24 = b.upc\
\cf5 and\cf0  b.retailer_code = $\cf2 13\cf0 \
\cf5 and\cf0  a.FIELD_24 <> \cf2 'UPC'\cf0 \
\cf5 and\cf0  a.FIELD_24 \cf3 is\cf0  \cf5 not\cf0  \cf3 null\cf0 \
\cf5 and\cf0  a.FIELD_24 <> \cf2 ' '\cf0 \
\cf5 and\cf0  \cf6 length\cf0 (a.FIELD_24) < \cf2 51\cf0 \
;\
\
\cf5 commit\cf0 ;\
\
