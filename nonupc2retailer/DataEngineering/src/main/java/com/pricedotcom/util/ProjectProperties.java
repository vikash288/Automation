...
public class ProjectProperties {
	...
	private static String eslinknonupc="eslinknonupc";
	private static String esindexnonupc="esindexnonupc";
	...
	public static String getEslinknonupc() throws IOException {
		prop.load(input);
		return prop.getProperty(eslinknonupc);
	}
	
	public static String getEsindexnonupc() throws IOException {
		prop.load(input);
		return prop.getProperty(esindexnonupc);
	}
