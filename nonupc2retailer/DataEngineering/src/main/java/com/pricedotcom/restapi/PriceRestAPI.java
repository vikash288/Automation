...
public String getUPC(String asin){		
	...
	try {		
		StringBuilder stringBuilder = 
				new StringBuilder("http://production12.getpriceapp.com/v2/price/asin-to-upc/");		
		stringBuilder.append("?asin=");	
		stringBuilder.append(URLEncoder.encode(asin, "UTF-8"));	
		System.out.println(stringBuilder.toString());		
		URL url = new URL(stringBuilder.toString());		
		HttpURLConnection con = (HttpURLConnection) url.openConnection();// By default it is GET request		
		con.setRequestMethod("GET");// add request header
		con.setRequestProperty("User-Agent", USER_AGENT);
		int responseCode = con.getResponseCode();
		System.out.println("Sending get request : " + url);
		System.out.println("Response code : " + responseCode);// Reading response from input Stream	
...
public String getCatId(String productTitle){
	...
	try {		
		StringBuilder stringBuilder = 
				new StringBuilder("http://production12.getpriceapp.com/v2/price/title_cat_search/");
		...
		//	System.out.println("..................."+id);
			int parentid= (Integer) obj.get("parent_cat_id");
...
public static void main(String[] args) {
	...
	api.getCatId("Michael Kors Size 4 Black Silk Button Detail Evening Gown #1507");
