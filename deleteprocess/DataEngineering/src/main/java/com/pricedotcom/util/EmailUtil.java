...
public class EmailUtil {
	...
	public static void main(String args[]) throws IOException {
		...
		String content = log.readLogFile("petco","/home/abhinandan/DUMP/log/petco/petco_2017-06-30.log");
		email.sendMailGet("Automation Full load process complete for Petco affiliate networks CJ",content);*/
