...
{
  >&2 echo "parsing $1, $2"
  python parse_feed_pepperjam.py $1 > /home/ubuntu/affiliate/pepperjam/data/$2_$$.tsv 2>> log/$2.err

  echo "LOAD DATA LOCAL INFILE '/home/ubuntu/affiliate/pepperjam/data/$2_$$.tsv' REPLACE INTO TABLE crawler.${2}_feed FIELDS TERMINATED BY '\t'" | mysql -u crawler -h crawler.ccnwaqixfpyj.us-east-1.rds.amazonaws.com -P 3306 -pprice123
