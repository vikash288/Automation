...
def load_mysql_staging(dbconn,staging_table_name,filepath):
    ...
    #Truncate Table
    truncatetable_cursor.execute("truncate STG_EBAY_USED_SAMPLE")
...
if __name__ == "__main__":
    ...
    #AWS S3 Access Key
    AWS_ACCESS_KEY = 'AKIAISEDXKBXS77YYJIQ'
    #AWS S3 Secret Key
    AWS_ACCESS_SECRET_KEY = 'msS5RL0hvnUznFko2ZI9M2MS06Z8H6fSgY+K0Olb'
    #Bucket Name
    AWS_BUCKET_NAME = 'abhinandan2016'
    #Retailer Number
    EBAY_USED_RETAILER_NO='120'
    #MySQL target Table Name for ebay used
    target_table_name = "PRICE_DOT_COM_TRGT.TGT_EBAY_USED_SAMPLE"

    #Mysql RDS Database Connection
    db = MySQLdb.connect("crawler.ccnwaqixfpyj.us-east-1.rds.amazonaws.com","crawler","price123","production" , local_infile = 1 )

    #File path location
    filepath = '/home/abhinandan/Desktop'
